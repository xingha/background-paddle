...
DATA_PATH = {
    'videomatte240k': {
        'train': {
            'fgr': r'D:\data\bgmat\VideoMatte240K_JPEG_SD\test\fgr',
            'pha': r'D:\data\bgmat\VideoMatte240K_JPEG_SD\test\pha'
        },
        'valid': {
            'fgr': r'D:\data\bgmat\VideoMatte240K_JPEG_SD\test\fgr',
            'pha': r'D:\data\bgmat\VideoMatte240K_JPEG_SD\test\pha'
    ...
    'backgrounds': {
        'train': r'D:\data\bgmat\background',
        'valid': r'D:\data\bgmat\background'
    },
}